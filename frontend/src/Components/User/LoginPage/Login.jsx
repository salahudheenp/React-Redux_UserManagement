...
function Login() {
  ...
  return (
    ...
    <>
      <div className='baground ' style={{ display: 'flex', justifyContent: 'center', backgroundColor: " rgb(65, 199, 28)" }}>
        {/* <div className='logo'>
          ...
          <div className='formcontainer' style={{ height: 450 }}>
            ...
            <form action="">
              ...
              <div className='buttons'>
                ...
                <button onClick={handlesubmit} className='button1' style={{ backgroundColor: 'blue', height: 40, width: 100 }}>Login</button>
                <Link to={'/signup'}>
                  <button style={{ backgroundColor: 'red', height: 40, width: 100 }} className='button2 mt-2'>SignUp</button>
                </Link>
              </div>
            </form>
          </div>
